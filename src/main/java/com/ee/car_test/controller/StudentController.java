...
public class StudentController {
    ...
    public String studentList(
        ...
        Page<Student> studentList = studentService.getStudentListByStatus(status,o);
    ...
    @RequestMapping(path = "/studentListPage",method = RequestMethod.POST)
    public String studentListPage(
        ...
        PageRequest o = PageRequest.of(n,10);
        Page<Student> studentList = studentService.getStudentList(o);
        model.addAttribute("listByStatus",studentList);
        return "studentList";
    }

    @RequestMapping(path = "/studentGradeListPage",method = RequestMethod.POST)
    public String studentGradeListPage(
            @RequestParam(name = "number")
            int n,
            Model model, HttpSession session){
        User user =(User) session.getAttribute("user");
